...
ROLES = {
    ...
    'protocol/schemas/end-work.schema.json':'NORMATIVE_WIRE_SCHEMA',
...
def main():
    ...
    payload={
        ...
        'canon_id':'ASET-WORKER-CANON-0.1-ALPHA2','version':'0.1.0-alpha.1','files':files
    }
